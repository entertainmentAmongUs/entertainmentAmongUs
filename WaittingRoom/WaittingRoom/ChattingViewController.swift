...
class ChattingViewController: UITableViewController, UITextFieldDelegate {
    
    let chatIdentifier = "chat"
    
    func setTableView() {
        
        self.tableView.register(ChatCell.self, forCellReuseIdentifier: self.chatIdentifier)
