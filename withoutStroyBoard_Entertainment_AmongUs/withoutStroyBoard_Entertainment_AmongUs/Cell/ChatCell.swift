...
//
//  Created by 남궁광 on 2022/03/06.
//
import UIKit
//model이랑 새로 입력된 놈을 보여주는 넘이다.
class ChatCell: UITableViewCell {
    ...
    func addNicknameLabel() {
        ...
        nickname.font = UIFont.systemFont(ofSize: 12, weight: .medium)
    ...
    func addChattingLabel() {
        ...
        chatting.font = UIFont.systemFont(ofSize: 12)
